...
import { inOrderPieces } from "./piece-table-stream.js";

export { getValueStream, inOrderPieces } from "./piece-table-stream.js";
export type { DocumentChunk, StreamOptions } from "./piece-table-stream.js";
...
// =============================================================================
//
// The pure byte↔char conversion helpers live in ./piece-table-offset-convert.ts.
// They are re-exported here to preserve the public `piece-table.js` import surface.

export { charToByteOffset, byteToCharOffset } from "./piece-table-offset-convert.js";
